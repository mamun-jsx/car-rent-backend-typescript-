...
route.put("/api/v1/vehicles/:vehicleId", auth("admin"), vehicleControllers.updateVehicle);
route.delete("/api/v1/vehicles/:vehicleId", auth("admin"), vehicleControllers.deleteVehicle);
