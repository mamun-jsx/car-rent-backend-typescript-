...
const createBooking = async (payload) => {
    ...
    const vehicleCheck = await pool.query(`SELECT * FROM vehicles WHERE id = $1 AND availability_status = 'available'`, [vehicle_id]);
...
// ? ============================== Get Booking ==========================================================
const getBooking = async (role, userId) => {
...
// ? ============================== Update Booking ==========================================================
const updateBooking = async (id, status, user) => {
    // Get booking
